...
// beforeEach(() => { // roda antes de cada teste -> define suas 'configurações'
//     cities = ['Pindamonhangaba'];
//   });
  
// afterEach(() => { // roda depois dos testes -> 'reseta' 'limpa' valores que foram manipulados durante teste
//     cities = [];
//   });
