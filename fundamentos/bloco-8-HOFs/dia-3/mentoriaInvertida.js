...
const evenIds = () => techProducts.map((products) => products.id % 2 === 0);
console.log(evenIds())
/*
...
*/
const getPrice = (id, quantidade) => {
    const getPrice = techProducts.find((produto) => (produto.id === id))
    return getPrice.price * quantidade;
}
