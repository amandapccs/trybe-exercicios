...
describe('Verifica função sum', () => {
  test('A função sum retorna 9 quando recebe 4 e 5', () => {
    expect(sum(4, 5)).toBe(9)
  });
  test('A função retorna 0 se parâmetros são 0 e 0', () => {
    expect(sum(0, 0)).toBe(0)
  })
  test('A função lança erro se tiver tipo string', () => {
    expect(() => sum(4, "5")).toThrow()
  });
  test('A função exibe mensagem de erro', () => {
...
describe('Função encode e decode', () => {
  test('Teste se encode e decode são uma função', () => {
  ...
  test('String retornada tem mesmo tamanho de caracteres que string original', () => {
